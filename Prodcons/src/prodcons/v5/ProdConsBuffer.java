...
public class ProdConsBuffer implements IProdConsBuffer {
    ...
    public Message get() throws InterruptedException {
        ...
        synchronized (this) {
            ...
            m = buffer[out];
            System.out.println("Le consommateur : " + Thread.currentThread().getName() + " , consomme (1) le Message : "
                    + m.getId() + " dans la case " + out);
            out = (out + 1) % buffSize;
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < k; i++) {
                ...
                System.out.println("Le consommateur : " + Thread.currentThread().getName() + " , consomme (" + k
                        + ") le Message : " + buffer[out].getId() + " dans la case " + out);
                out = (out + 1) % buffSize;
